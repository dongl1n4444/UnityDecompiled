namespace UnityEditor
{
    ...
    internal class AssetStoreLoginWindow : EditorWindow
    {
        ...
        private static void LoadLogos()
        {
            ...
            {
                s_AssetStoreLogo = new GUIContent("");
            }
        }

        public static void Login(string loginReason, LoginCallback callback)
        {
            <Login>c__AnonStorey0 storey = new <Login>c__AnonStorey0 {
                callback = callback,
            ...
            {
                AssetStoreClient.LoginWithRememberedSession(new AssetStoreClient.DoneLoginCallback(storey.<>m__0));
            }
        }
