namespace UnityEditor
{
    ...
    {
        [CompilerGenerated]
        private static Func<AudioMixerController, int> <>f__am$cache0;
        [CompilerGenerated]
        private static Func<AudioMixerController, int> <>f__am$cache1;
        ...
        private void OnMixersDroppedOnMixerCallback(List<AudioMixerController> draggedMixers, AudioMixerController droppedUponMixer)
        {
            ...
            else
            {
                ...
                ObjectSelector.get.Show(obj2, typeof(AudioMixerGroup), null, false, allowedInstanceIDs);
        ...
        {
            AudioMixerItem item = (AudioMixerItem) this.m_TreeView.FindItem(index);
            if (item != null)
            {
