namespace UnityEditor.TestTools.TestRunner
{
    ...
    internal class PlayerLauncherContextSettings : IDisposable
    {
        ...
        private void CleanupProjectParameters()
        {
            ...
            PlayerSettings.applicationIdentifier = this.m_OldApplicationIdentifier;
            PlayerSettings.productName = this.m_OldproductName;
        ...
        private void SetupProjectParameters()
        {
            ...
            this.m_OldApplicationIdentifier = PlayerSettings.applicationIdentifier;
            PlayerSettings.applicationIdentifier = "com.UnityTestRunner.UnityTestRunner";
            this.m_OldproductName = PlayerSettings.productName;
