namespace UnityEditor
{
    ...
    internal class AvatarEditor : Editor
    {
        ...
        internal override SerializedObject GetSerializedObjectInternal()
        {
            ...
            if (base.m_SerializedObject == null)
            {
                base.m_SerializedObject = new SerializedObject(AssetImporter.GetAtPath(AssetDatabase.GetAssetPath(base.target)));
            }
        ...
        internal void SwitchToAssetMode()
        {
            ...
            {
                <SwitchToAssetMode>c__AnonStorey0 storey = new <SwitchToAssetMode>c__AnonStorey0 {
                    $this = this,
                    CleanUpSceneOnDestroy = null
                };
                storey.CleanUpSceneOnDestroy = new EditorApplication.CallbackFunction(storey.<>m__0);
        ...
        internal void SwitchToEditMode()
        {
            ...
            try
            {
                while (enumerator.MoveNext())
                {
                    ...
                    current.m_SceneViewState.showImageEffects = false;
        ...
        [CompilerGenerated]
        private sealed class <SwitchToAssetMode>c__AnonStorey0
        {
            internal AvatarEditor $this;
            ...
            internal void <>m__0()
            {
                if (SceneManager.GetActiveScene().path.Length <= 0)
                {
                    if ((this.$this.sceneSetup != null) && (this.$this.sceneSetup.Length > 0))
                    {
                        EditorSceneManager.RestoreSceneManagerSetup(this.$this.sceneSetup);
                        this.$this.sceneSetup = null;
                    }
                    else
                    {
                        EditorSceneManager.NewScene(NewSceneSetup.DefaultGameObjects);
