    ...
    internal class AvatarMappingEditor : AvatarSubEditor
    {
        ...
        protected void ApplyTemplate()
        {
            ...
            if (template != null)
            {
                ...
                {
                    <ApplyTemplate>c__AnonStorey1 storey = new <ApplyTemplate>c__AnonStorey1 {
        ...
        protected void AutoMapping()
        {
            ...
            foreach (KeyValuePair<int, Transform> pair in dictionary)
            {
                        ...
                        for (int k = 0; k < this.m_BodyPartHumanBone[i].Length; k++)
                        {
                            ...
                            if (index != -1)
                            {
                                ...
                                switch (i)
                                {
                                    ...
                                    case 6:
                                    case 8:
                                        humanBoneName = humanBoneName.Replace("Right", "");
                                        break;
                                }
                                if (((i == 3) || (i == 4)) || (i == 7))
                                {
                                    humanBoneName = humanBoneName.Replace("Left", "");
                                }
        ...
        {
            <GetBoneState>c__AnonStorey0 storey = new <GetBoneState>c__AnonStorey0();
            error = string.Empty;
        ...
        private HumanTemplate OpenHumanTemplate()
        {
            ...
            HumanTemplate template2 = AssetDatabase.LoadMainAssetAtPath(FileUtil.GetProjectRelativePath(path)) as HumanTemplate;
            if ((template2 == null) && EditorUtility.DisplayDialog("Human Template not found in project", "Import asset '" + path + "' into project", "Yes", "No"))
            {
                ...
                template2 = AssetDatabase.LoadMainAssetAtPath(to) as HumanTemplate;
                if (template2 == null)
                {
        ...
        [CompilerGenerated]
        private sealed class <ApplyTemplate>c__AnonStorey1
        {
        ...
        [CompilerGenerated]
        private sealed class <GetBoneState>c__AnonStorey0
        {
