    ...
    internal class DefaultSolutionSynchronizationSettings : ISolutionSynchronizationSettings
    {
        ...
        public virtual string GetProjectHeaderTemplate(ScriptingLanguage language)
        {
            string[] textArray1 = new string[] { 
                ...
                "    <NoWarn>0169</NoWarn>", "  </PropertyGroup>", "  <ItemGroup>", "    <Reference Include=\"System\" />", "    <Reference Include=\"System.XML\" />", "    <Reference Include=\"System.Core\" />", "    <Reference Include=\"System.Runtime.Serialization\" />", "    <Reference Include=\"System.Xml.Linq\" />", "    <Reference Include=\"UnityEngine\">", "      <HintPath>{3}</HintPath>", "    </Reference>", "    <Reference Include=\"UnityEditor\">", "      <HintPath>{4}</HintPath>", "    </Reference>", "  </ItemGroup>", "  <ItemGroup>",
                ""
            };
            return string.Join("\r\n", textArray1);
        }
        ...
        public virtual string SolutionTemplate
        {
            ...
            {
                string[] textArray1 = new string[] { 
                    "", "Microsoft Visual Studio Solution File, Format Version {0}", "# Visual Studio {1}", "{2}", "Global", "    GlobalSection(SolutionConfigurationPlatforms) = preSolution", "        Debug|Any CPU = Debug|Any CPU", "        Release|Any CPU = Release|Any CPU", "    EndGlobalSection", "    GlobalSection(ProjectConfigurationPlatforms) = postSolution", "{3}", "    EndGlobalSection", "    GlobalSection(SolutionProperties) = preSolution", "        HideSolutionNode = FALSE", "    EndGlobalSection", "{4}",
                    "EndGlobal", ""
                };
                return string.Join("\r\n", textArray1).Replace("    ", "\t");
            }
