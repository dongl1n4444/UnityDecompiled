namespace UnityEditor
{
    ...
    internal class AvatarAutoMapper
    {
        ...
        private void DebugMatchChoice(List<BoneMatch> matches)
        {
            ...
            {
                str2 = message;
                string[] textArray1 = new string[] { str2, matches[i].bone.name, " (", matches[i].score.ToString("0.0"), " / ", matches[i].totalSiblingScore.ToString("0.0"), "), " };
            ...
            foreach (BoneMatch match in matches)
            {
                ...
                foreach (string str3 in match.debugTracker)
                {
                    message = message + "\n    - " + str3;
                }
            }
