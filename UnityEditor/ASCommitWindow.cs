namespace UnityEditor
{
    ...
    {
        [CompilerGenerated]
        private static Comparison<ParentViewFile> <>f__mg$cache0;
        [CompilerGenerated]
        private static Comparison<ParentViewFolder> <>f__mg$cache1;
        [CompilerGenerated]
        private static Comparison<ParentViewFile> <>f__mg$cache2;
        [CompilerGenerated]
        private static Comparison<ParentViewFolder> <>f__mg$cache3;
        private string[] commitMessageList;
        private static Constants constants = null;
        internal string description;
        private string dragTitle = string.Empty;
        private string[] dropDownMenuItems = new string[] { "", "", "Compare", "Compare Binary", "", "Discard" };
        private string[] guidsToTransferToTheRightSide = null;
        ...
        private bool DoTransfer(ref ParentViewFolder[] foldersFrom, ref ParentViewFolder[] foldersTo, int folder, int file, ref List<string> guidsOfFoldersToRemove, bool leftToRight)
        {
            ...
            if (folder3 != null)
            {
                ...
                Array.Sort<ParentViewFile>(folder3.files, <>f__mg$cache0);
            }
            if (flag2)
            {
                if (<>f__mg$cache1 == null)
                {
                    <>f__mg$cache1 = new Comparison<ParentViewFolder>(ParentViewState.CompareViewFolder);
                }
                Array.Sort<ParentViewFolder>(foldersTo, <>f__mg$cache1);
            }
            return flag;
        }
        ...
        public static bool MarkAllFolderDependenciesForDiscarding(ParentViewState pvState, ParentViewState anotherPvState)
        {
            ...
            if (anotherPvState != null)
            {
                ...
                for (int num8 = anotherPvState.folders.Length - 1; num8 >= 0; num8--)
                {
                    ...
                    if (num9 != -1)
                    {
                        ...
                        {
                            <>f__mg$cache2 = new Comparison<ParentViewFile>(ParentViewState.CompareViewFile);
                        }
                        Array.Sort<ParentViewFile>(folder4.files, <>f__mg$cache2);
                    }
                    else
                    {
                        num9 = 0;
            ...
            if (flag2)
            {
                ...
                {
                    <>f__mg$cache3 = new Comparison<ParentViewFolder>(ParentViewState.CompareViewFolder);
                }
                Array.Sort<ParentViewFolder>(pvState.folders, <>f__mg$cache3);
            }
            return flag;
        }
