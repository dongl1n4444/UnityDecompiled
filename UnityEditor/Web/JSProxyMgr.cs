namespace UnityEditor.Web
{
    ...
    internal class JSProxyMgr
    {
        ...
        private static readonly string[] s_IgnoredMethods = new string[] { "Equals", "GetHashCode", "GetType", "ToString" };
        ...
        {
            <DoInvokeMessage>c__AnonStorey0 storey = new <DoInvokeMessage>c__AnonStorey0 {
                callback = callback,
                messageID = messageID
            };
            ...
            this.AddTask(new TaskCallback(storey.<>m__0));
            return true;
        }
        ...
        public bool DoMessage(string jsonRequest, ExecCallback callback, WebView webView)
        {
            ...
            try
            {
                ...
                double num2 = double.Parse((string) jsonData["version"], CultureInfo.InvariantCulture);
        ...
        private object InternalParseParam(System.Type type, object data)
        {
            ...
            if (list != null)
            {
                ...
                {
                    object obj3 = this.InternalParseParam(elementType, list[i]);
                    list2.Add(obj3);
                }
            ...
            if (dictionary != null)
            {
                ...
                foreach (System.Reflection.FieldInfo info2 in list3)
                {
                    try
                    {
                        object obj5 = this.InternalParseParam(info2.FieldType, dictionary[info2.Name]);
                        info2.SetValue(obj4, obj5);
                    }
                ...
                foreach (PropertyInfo info3 in list4)
                {
                    try
                    {
                        object obj6 = this.InternalParseParam(info3.PropertyType, dictionary[info3.Name]);
                        MethodInfo setMethod = info3.GetSetMethod();
                        if (setMethod != null)
                        {
                            object[] parameters = new object[] { obj6 };
                            setMethod.Invoke(obj4, parameters);
                        }
                    }
                    catch (KeyNotFoundException)
                    {
                ...
                return Convert.ChangeType(obj4, type);
            }
