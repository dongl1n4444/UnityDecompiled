    ...
    internal class GraphicsSettingsWindow
    {
        ...
        internal class TierSettingsEditor : Editor
        {
            ...
            internal void OnFieldLabelsGUI(bool vertical)
            {
                ...
                EditorGUILayout.LabelField(Styles.prefer32BitShadowMaps, new GUILayoutOption[0]);
            ...
            internal class Styles
            {
                ...
                static Styles()
                {
                    ...
                    prefer32BitShadowMaps = EditorGUIUtility.TextContent("Prefer 32 bit shadow maps");
