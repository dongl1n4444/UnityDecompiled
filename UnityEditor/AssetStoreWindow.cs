namespace UnityEditor
{
    ...
    internal class AssetStoreWindow : EditorWindow, IHasCustomMenu
    {
        ...
        {
            <ScheduleOpenURL>c__AnonStorey0 storey = new <ScheduleOpenURL>c__AnonStorey0 {
                timeout = timeout,
                $this = this
            };
        ...
        {
            internal AssetStoreWindow $this;
            internal TimeSpan timeout;

            internal void <>m__0(object)
            {
                Thread.Sleep(this.timeout);
                this.$this.m_ShouldRetryInitialURL = true;
            }
        }
    }
}
