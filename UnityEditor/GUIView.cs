namespace UnityEditor
{
    ...
    internal class GUIView : View
    {
        ...
        public static GUIView current { [MethodImpl(MethodImplOptions.InternalCall)] get; }
        public static GUIView focusedView { [MethodImpl(MethodImplOptions.InternalCall)] get; }
        public static GUIView mouseOverView { [MethodImpl(MethodImplOptions.InternalCall)] get; }
        public bool hasFocus { [MethodImpl(MethodImplOptions.InternalCall)] get; }
        internal bool mouseRayInvisible { [MethodImpl(MethodImplOptions.InternalCall)] get; [MethodImpl(MethodImplOptions.InternalCall)] set; }
