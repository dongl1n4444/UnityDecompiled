    ...
    internal class TargetChoiceHandler
    {
        ...
        internal static void AddSetToValueOfTargetMenuItems(GenericMenu menu, SerializedProperty property, TargetChoiceMenuFunction func)
        {
            ...
            foreach (Object obj2 in targetObjects)
            {
                ...
                {
                    <>f__mg$cache0 = new GenericMenu.MenuFunction2(TargetChoiceHandler.TargetChoiceForwardFunction);
                }
                menu.AddItem(EditorGUIUtility.TextContent(item), false, <>f__mg$cache0, new PropertyAndTargetHandler(property2, obj2, func));
            }
        }
