    ...
    internal class LightingWindowBakeSettings
    {
        ...
        private static class Styles
        {
            ...
            static Styles()
            {
                ...
                PVRFilteringGaussRadiusAO = EditorGUIUtility.TextContent("Ambien Occlusion Radius|The radius of the filter for ambient occlusion in the lightmap. A higher radius will increase the blur strength, reducing sampling noise from ambient occlusion in the lightmap.");
