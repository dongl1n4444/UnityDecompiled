namespace UnityEditor.UI
{
    ...
    public class ScrollRectEditor : Editor
    {
        ...
        {
            this.m_ShowElasticity.valueChanged.RemoveListener(new UnityAction(this.Repaint));
            this.m_ShowDecelerationRate.valueChanged.RemoveListener(new UnityAction(this.Repaint));
        }
        ...
        protected virtual void OnEnable()
        {
            ...
            this.m_ShowElasticity = new AnimBool(new UnityAction(this.Repaint));
            this.m_ShowDecelerationRate = new AnimBool(new UnityAction(this.Repaint));
        ...
        public override void OnInspectorGUI()
        {
            ...
            if ((this.m_HorizontalScrollbar.objectReferenceValue != null) && !this.m_HorizontalScrollbar.hasMultipleDifferentValues)
            {
                EditorGUI.indentLevel++;
            ...
            if ((this.m_VerticalScrollbar.objectReferenceValue != null) && !this.m_VerticalScrollbar.hasMultipleDifferentValues)
            {
                EditorGUI.indentLevel++;
