namespace UnityEditor.UI
{
    ...
    public class InputFieldEditor : SelectableEditor
    {
        ...
        {
            base.OnDisable();
            this.m_CustomColor.valueChanged.RemoveListener(new UnityAction(this.Repaint));
        }
        ...
        protected override void OnEnable()
        {
            ...
            this.m_CustomColor.valueChanged.AddListener(new UnityAction(this.Repaint));
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            {
                Text objectReferenceValue = this.m_TextComponent.objectReferenceValue as Text;
                if (objectReferenceValue.supportRichText)
                {
