namespace UnityEditor.WebGL
{
    ...
    internal class WebGlBuildPostprocessor : DefaultBuildPostprocessor
    {
        ...
        private bool AssembleBackground(BuildPostProcessArgs args, string outputPath)
        {
            ...
            Texture2D tex = new Texture2D(splashScreenActualBackgroundImage.width, splashScreenActualBackgroundImage.height);
        ...
        public static void CompressAndMarkBrotli(string path)
        {
            ...
            string str3 = "Brotli-0.4.0-py2.7-" + ((Application.platform != RuntimePlatform.WindowsEditor) ? "macosx-10.10-x86_64" : "win-amd64") + ".egg";
