namespace UnityEditor.Connect
{
    ...
    internal class UnityConnectPrefs
    {
        ...
        public static string FixUrl(string url, string serviceName)
        {
            ...
            if (serviceEnv != 0)
            {
                ...
                if (str.StartsWith("file://"))
                {
                    ...
                    if (serviceEnv == 3)
                    {
                        string str4 = EditorPrefs.GetString(ServicePrefKey("CloudPanelCustomUrl", serviceName));
        ...
        protected static CloudPanelPref GetPanelPref(string serviceName)
        {
            ...
            CloudPanelPref pref2 = new CloudPanelPref(serviceName);
            m_CloudPanelPref.Add(serviceName, pref2);
            return pref2;
        }
