namespace UnityEditor
{
    ...
    internal class OtherRenderingEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(this.m_HaloTexture, Styles.HaloTexture, new GUILayoutOption[0]);
            EditorGUILayout.Slider(this.m_HaloStrength, 0f, 1f, Styles.HaloStrength, new GUILayoutOption[0]);
            EditorGUILayout.PropertyField(this.m_FlareFadeSpeed, Styles.FlareFadeSpeed, new GUILayoutOption[0]);
            EditorGUILayout.Slider(this.m_FlareStrength, 0f, 1f, Styles.FlareStrength, new GUILayoutOption[0]);
            EditorGUILayout.PropertyField(this.m_SpotCookie, Styles.SpotCookie, new GUILayoutOption[0]);
