namespace UnityEditor.Android
{
    ...
    internal abstract class AndroidProjectExport
    {
        ...
        protected bool m_minifyDebug;
        protected bool m_minifyRelease;
        ...
        protected bool m_useProguardDebug;
        protected bool m_useProguardRelease;
        ...
        private void Init(PostProcessorContext context, string targetPath)
        {
            ...
            int num = context.Get<int>("Minification");
            int num2 = num & 3;
            int num3 = num >> 2;
            this.m_minifyRelease = num2 != 0;
            this.m_useProguardRelease = num2 == 1;
            this.m_minifyDebug = num3 != 0;
            this.m_useProguardDebug = num3 == 1;
        }
