namespace UnityEditor.Android
{
    ...
    internal class AndroidBuildWindowExtension : DefaultBuildWindowExtension
    {
        ...
        private readonly GUIContent m_BuildTypeString = EditorGUIUtility.TextContent("Build Type");
        ...
        public override void ShowPlatformBuildOptions()
        {
            ...
            if (!this.ShouldDrawDevelopmentPlayerCheckbox())
            {
                ...
                EditorUserBuildSettings.androidBuildType = (AndroidBuildType) EditorGUILayout.Popup(this.m_BuildTypeString, androidBuildType, this.buildTypeStrings, new GUILayoutOption[0]);
