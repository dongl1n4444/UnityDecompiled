...
{previousLODPercentage * 100f:0}%";
        ...
        {
            <SetSelectedLODLevelPercentage>c__AnonStorey0 storey = new <SetSelectedLODLevelPercentage>c__AnonStorey0 {
                lods = lods,
                lod = lod
            };
            ...
            rawScreenPercent = Mathf.Clamp01(rawScreenPercent);
            storey.lods[storey.lod].RawScreenPercent = Mathf.Clamp(newScreenPercentage, rawScreenPercent, num2);
        }
        ...
        [CompilerGenerated]
        private sealed class <SetSelectedLODLevelPercentage>c__AnonStorey0
        {
            internal int lod;
