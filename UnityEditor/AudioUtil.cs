namespace UnityEditor
{
    ...
    internal sealed class AudioUtil
    {
        ...
        public static bool canUseSpatializerEffect { [MethodImpl(MethodImplOptions.InternalCall)] get; }

        public static bool resetAllAudioClipPlayCountsOnPlay { [MethodImpl(MethodImplOptions.InternalCall)] get; [MethodImpl(MethodImplOptions.InternalCall)] set; }
    }
}
