namespace UnityEditor.VersionControl
{
    ...
    internal class WindowCheckoutFailure : EditorWindow
    {
        ...
        public void OnGUI()
        {
            ...
            Rect rect4 = new Rect(6f, (40f + height) + 40f, base.position.width - 12f, height);
            ...
            GUILayout.EndArea();
            this.checkoutSuccessList.OnGUI(new Rect(rect4.x + 2f, rect4.y + 2f, rect4.width - 4f, rect4.height - 4f), true);
