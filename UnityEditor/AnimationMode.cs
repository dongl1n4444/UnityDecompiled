namespace UnityEditor
{
    ...
    public sealed class AnimationMode
    {
        ...
        [MethodImpl(MethodImplOptions.InternalCall), GeneratedByOldBindingsGenerator]
        internal static extern void InitializePropertyModificationForObject(Object target, AnimationClip clip);
        [MethodImpl(MethodImplOptions.InternalCall), GeneratedByOldBindingsGenerator]
        ...
        [MethodImpl(MethodImplOptions.InternalCall), GeneratedByOldBindingsGenerator]
        internal static extern void RevertPropertyModificationsForObject(Object target);
        /// <summary>
