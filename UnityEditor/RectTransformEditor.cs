namespace UnityEditor
{
    ...
    internal class RectTransformEditor : Editor
    {
        ...
        [CompilerGenerated]
        private static FloatSetter <>f__am$cache11;
        [CompilerGenerated]
        private static FloatGetter <>f__am$cache12;
        [CompilerGenerated]
        private static FloatSetter <>f__am$cache13;
        [CompilerGenerated]
        private static FloatGetter <>f__am$cache14;
        [CompilerGenerated]
        private static FloatSetter <>f__am$cache15;
        [CompilerGenerated]
        private static FloatGetter <>f__am$cache16;
        [CompilerGenerated]
        private static FloatSetter <>f__am$cache17;
        [CompilerGenerated]
        private static FloatGetter <>f__am$cache18;
        [CompilerGenerated]
        private static FloatSetter <>f__am$cache19;
        [CompilerGenerated]
        private static FloatGetter <>f__am$cache1A;
        [CompilerGenerated]
        private static FloatGetter <>f__am$cache1B;
        [CompilerGenerated]
        private static FloatGetter <>f__am$cache1C;
        [CompilerGenerated]
        private static FloatGetter <>f__am$cache1D;
        [CompilerGenerated]
        private static FloatGetter <>f__am$cache1E;
        [CompilerGenerated]
        ...
        [CompilerGenerated]
        private static FloatSetter <>f__am$cache9;
        [CompilerGenerated]
        private static FloatGetter <>f__am$cacheA;
        [CompilerGenerated]
        private static FloatSetter <>f__am$cacheB;
        [CompilerGenerated]
        private static FloatGetter <>f__am$cacheC;
        [CompilerGenerated]
        private static FloatSetter <>f__am$cacheD;
        [CompilerGenerated]
        private static FloatGetter <>f__am$cacheE;
        [CompilerGenerated]
        private static FloatSetter <>f__am$cacheF;
        [CompilerGenerated]
        ...
        private unsafe void AnchorSceneGUI(RectTransform gui, RectTransform guiParent, Transform parentSpace, bool interactive, int minmaxX, int minmaxY, int id)
        {
            ...
            if (interactive)
            {
                ...
                Vector3 position = Handles.Slider2D(id, anchor, parentSpace.forward, parentSpace.right, parentSpace.up, handleSize, (Handles.CapFunction) null, Vector2.zero);
                ...
                if (EditorGUI.EndChangeCheck())
                {
                    ...
                    Vector2 vector8 = parentSpace.InverseTransformVector(position - anchor);
                    for (int i = 0; i <= 1; i++)
                    {
                        ref Vector2 vectorRef;
                        int num3;
                        (vectorRef = (Vector2) &vector8)[num3 = i] = vectorRef[num3] / guiParent.rect.size[i];
                        int minmax = (i != 0) ? minmaxY : minmaxX;
                        bool isMax = minmax == 1;
                        float num5 = !isMax ? gui.anchorMin[i] : gui.anchorMax[i];
                        float num6 = num5 + vector8[i];
                        float num7 = num6;
                        ...
                        if (minmax == 0)
                        {
                            num7 = Mathf.Min(num7, gui.anchorMax[i]);
                        }
                        if (minmax == 1)
                        {
                            num7 = Mathf.Max(num7, gui.anchorMin[i]);
                        }
                        ...
                        if (minmax == 2)
                        {
                            SetAnchorSmart(gui, num6, i, false, !eventBefore.shift, enforceExactValue, false, s_DragAnchorsTogether);
                            SetAnchorSmart(gui, num6, i, true, !eventBefore.shift, enforceExactValue, false, s_DragAnchorsTogether);
                        }
                        else
                        {
                            SetAnchorSmart(gui, num6, i, isMax, !eventBefore.shift, enforceExactValue, true, s_DragAnchorsTogether);
                        }
        ...
        private void DrawAnchorDistances(Transform parentSpace, RectTransform gui, RectTransform guiParent, float size, float alpha)
        {
            if ((guiParent != null) && (alpha > 0f))
            {
                ...
                for (int j = 0; j < 2; j++)
                {
                    Vector3 vector3 = (Vector3) ((((j != 0) ? parentSpace.up : parentSpace.right) * size) * 2f);
                    ...
                    if (num4 > 0)
                    {
                        this.DrawLabelBetweenPoints(vectorArray[j, 0] - vector3, vectorArray[j, 1] - vector3, GUIContent.Temp(num4.ToString() + "%"));
                    }
                    if (num5 > 0)
                    {
                        this.DrawLabelBetweenPoints(vectorArray[j, 1] - vector3, vectorArray[j, 2] - vector3, GUIContent.Temp(num5.ToString() + "%"));
                    }
                    if (num6 > 0)
                    {
                        this.DrawLabelBetweenPoints(vectorArray[j, 2] - vector3, vectorArray[j, 3] - vector3, GUIContent.Temp(num6.ToString() + "%"));
                    }
                }
            }
        }
        ...
        private void DrawSizeDistances(Transform userSpace, Rect rectInParentSpace, Transform parentSpace, RectTransform gui, RectTransform guiParent, float size, int axis, float alpha)
        {
            if (alpha > 0f)
            {
                ...
                Vector3 vector2 = (Vector3) ((((axis != 0) ? userSpace.right : userSpace.up) * size) * 2f);
                this.DrawLabelBetweenPoints(s_Corners[0] + vector2, s_Corners[(axis != 0) ? 1 : 3] + vector2, label);
            }
        }
        ...
        {
            <FloatField>c__AnonStorey1 storey = new <FloatField>c__AnonStorey1 {
                driven = driven,
                getter = getter
            };
        ...
        {
            <FloatFieldLabelAbove>c__AnonStorey0 storey = new <FloatFieldLabelAbove>c__AnonStorey0 {
                driven = driven,
                getter = getter
            };
            using (new EditorGUI.DisabledScope(Enumerable.Any<UnityEngine.Object>(base.targets, new Func<UnityEngine.Object, bool>(storey.<>m__0))))
        ...
        private void HandleDragChange(string handleName, bool dragging)
        {
            ...
            if (handleName != null)
            {
                ...
                if (<>f__switch$map1.TryGetValue(handleName, out num))
                {
                    switch (num)
                    {
                        case 0:
        ...
        private void LayoutDropdownButton(bool anyWithoutParent)
        {
            ...
            using (new EditorGUI.DisabledScope(anyWithoutParent))
            {
                ...
                if (EditorGUI.DropdownButton(position, GUIContent.none, FocusType.Passive, "box"))
                {
        ...
        {
            RectTransform target = base.target as RectTransform;
                ...
                for (int i = 0; i <= 2; i++)
                {
                    for (int j = 0; j <= 2; j++)
                    {
                        if ((i == 1) != (j == 1))
                        {
                            ...
                            int controlID = GUIUtility.GetControlID(s_ParentRectPreviewHandlesHash, FocusType.Passive);
                            ...
                            if (EditorGUI.EndChangeCheck())
                            {
                                Vector2 vector7 = space.InverseTransformPoint(zero);
                                Vector2 vector8 = space.InverseTransformPoint(position);
                                Rect rect2 = rect;
                                Vector2 vector9 = vector8 - vector7;
                                switch (i)
                                {
                                    case 0:
                                        rect2.min = new Vector2(rect2.min.x + vector9.x, rect2.min.y);
                                        break;

                                    case 2:
                                        rect2.max = new Vector2(rect2.max.x + vector9.x, rect2.max.y);
                                        break;
                                }
                                if (j == 0)
                                {
                                    rect2.min = new Vector2(rect2.min.x, rect2.min.y + vector9.y);
                                }
                                if (j == 2)
                                {
                                    rect2.max = new Vector2(rect2.max.x, rect2.max.y + vector9.y);
                                }
        ...
        public static unsafe void SetAnchorSmart(RectTransform rect, float value, int axis, bool isMax, bool smart, bool enforceExactValue, bool enforceMinNoLargerThanMax, bool moveTogether)
        {
            ...
            {
                Vector2 vector13 = rect.anchorMin;
                vector13[axis] = value;
                rect.anchorMin = vector13;
                Vector2 vector14 = rect.anchorMax;
                if (moveTogether)
                {
                    vector14[axis] = (s_StartDragAnchorMax[axis] + vector13[axis]) - s_StartDragAnchorMin[axis];
                }
                rect.anchorMax = vector14;
            }
            if (smart)
            {
                ref Vector2 vectorRef;
                ...
                (vectorRef = (Vector2) &anchoredPosition)[num5 = axis] = vectorRef[num5] - num2;
                rect.anchoredPosition = anchoredPosition;
                if (!moveTogether)
                {
                    int num6;
                    Vector2 sizeDelta = rect.sizeDelta;
                    (vectorRef = (Vector2) &sizeDelta)[num6 = axis] = vectorRef[num6] + (f * (!isMax ? ((float) 1) : ((float) (-1))));
        ...
        private void SmartAnchorFields()
        {
            ...
            if (this.m_ShowLayoutOptions)
            {
                ...
                {
                    <>f__am$cache1A = rectTransform => rectTransform.anchorMin.x;
                }
                ...
                {
                    <>f__am$cache1C = rectTransform => rectTransform.anchorMax.x;
                }
        ...
        private void SmartPivotField()
        {
            ...
            {
                <>f__am$cache1E = rectTransform => rectTransform.pivot.x;
            }
        ...
        private void SmartPositionAndSizeFields(bool anyWithoutParent, bool anyDrivenX, bool anyDrivenY)
        {
            ...
            if ((flag3 || anyWithoutParent) || anyDrivenX)
            {
                ...
                {
                    <>f__am$cache8 = rectTransform => rectTransform.anchoredPosition.x;
                }
                if (<>f__am$cache9 == null)
                {
                    <>f__am$cache9 = (rectTransform, val) => rectTransform.anchoredPosition = new Vector2(val, rectTransform.anchoredPosition.y);
                }
                this.FloatFieldLabelAbove(columnRect, <>f__am$cache8, <>f__am$cache9, DrivenTransformProperties.AnchoredPositionX, new GUIContent("Pos X"));
            ...
            else
            {
                ...
                {
                    <>f__am$cacheA = rectTransform => rectTransform.offsetMin.x;
                }
                if (<>f__am$cacheB == null)
                {
                    <>f__am$cacheB = (rectTransform, val) => rectTransform.offsetMin = new Vector2(val, rectTransform.offsetMin.y);
                }
                this.FloatFieldLabelAbove(columnRect, <>f__am$cacheA, <>f__am$cacheB, DrivenTransformProperties.None, new GUIContent("Left"));
            ...
            if ((flag4 || anyWithoutParent) || anyDrivenY)
            {
                ...
                {
                    <>f__am$cacheC = rectTransform => rectTransform.anchoredPosition.y;
                }
                if (<>f__am$cacheD == null)
                {
                    <>f__am$cacheD = (rectTransform, val) => rectTransform.anchoredPosition = new Vector2(rectTransform.anchoredPosition.x, val);
                }
                this.FloatFieldLabelAbove(columnRect, <>f__am$cacheC, <>f__am$cacheD, DrivenTransformProperties.AnchoredPositionY, new GUIContent("Pos Y"));
            ...
            else
            {
                ...
                {
                    <>f__am$cacheE = rectTransform => -rectTransform.offsetMax.y;
                }
                if (<>f__am$cacheF == null)
                {
                    <>f__am$cacheF = (rectTransform, val) => rectTransform.offsetMax = new Vector2(rectTransform.offsetMax.x, -val);
                }
                this.FloatFieldLabelAbove(columnRect, <>f__am$cacheE, <>f__am$cacheF, DrivenTransformProperties.None, new GUIContent("Top"));
            ...
            {
                <>f__am$cache10 = rectTransform => rectTransform.transform.localPosition.z;
            }
            if (<>f__am$cache11 == null)
            {
                <>f__am$cache11 = (rectTransform, val) => rectTransform.transform.localPosition = new Vector3(rectTransform.transform.localPosition.x, rectTransform.transform.localPosition.y, val);
            }
            this.FloatFieldLabelAbove(columnRect, <>f__am$cache10, <>f__am$cache11, DrivenTransformProperties.AnchoredPositionZ, new GUIContent("Pos Z"));
            EditorGUI.EndProperty();
            ...
            if ((flag3 || anyWithoutParent) || anyDrivenX)
            {
                ...
                {
                    <>f__am$cache12 = rectTransform => rectTransform.sizeDelta.x;
                }
                if (<>f__am$cache13 == null)
                {
                    <>f__am$cache13 = (rectTransform, val) => rectTransform.sizeDelta = new Vector2(val, rectTransform.sizeDelta.y);
                }
                this.FloatFieldLabelAbove(columnRect, <>f__am$cache12, <>f__am$cache13, DrivenTransformProperties.SizeDeltaX, !flag ? new GUIContent("Width") : new GUIContent("W Delta"));
            ...
            else
            {
                ...
                {
                    <>f__am$cache14 = rectTransform => -rectTransform.offsetMax.x;
                }
                if (<>f__am$cache15 == null)
                {
                    <>f__am$cache15 = (rectTransform, val) => rectTransform.offsetMax = new Vector2(-val, rectTransform.offsetMax.y);
                }
                this.FloatFieldLabelAbove(columnRect, <>f__am$cache14, <>f__am$cache15, DrivenTransformProperties.None, new GUIContent("Right"));
            ...
            if ((flag4 || anyWithoutParent) || anyDrivenY)
            {
                ...
                {
                    <>f__am$cache16 = rectTransform => rectTransform.sizeDelta.y;
                }
                if (<>f__am$cache17 == null)
                {
                    <>f__am$cache17 = (rectTransform, val) => rectTransform.sizeDelta = new Vector2(rectTransform.sizeDelta.x, val);
                }
                this.FloatFieldLabelAbove(columnRect, <>f__am$cache16, <>f__am$cache17, DrivenTransformProperties.SizeDeltaY, !flag2 ? new GUIContent("Height") : new GUIContent("H Delta"));
            ...
            else
            {
                ...
                {
                    <>f__am$cache18 = rectTransform => rectTransform.offsetMin.y;
                }
                if (<>f__am$cache19 == null)
                {
                    <>f__am$cache19 = (rectTransform, val) => rectTransform.offsetMin = new Vector2(rectTransform.offsetMin.x, val);
                }
                this.FloatFieldLabelAbove(columnRect, <>f__am$cache18, <>f__am$cache19, DrivenTransformProperties.None, new GUIContent("Bottom"));
        ...
        [CompilerGenerated]
        private sealed class <FloatField>c__AnonStorey1
        {
        ...
        [CompilerGenerated]
        private sealed class <FloatFieldLabelAbove>c__AnonStorey0
        {
            internal DrivenTransformProperties driven;
            internal RectTransformEditor.FloatGetter getter;
