    ...
    internal class TreeViewTest
    {
        ...
        public void Init(Rect rect, BackendData backendData)
        {
            if (this.m_TreeView == null)
            {
                ...
                TreeViewStateWithColumns treeViewState = new TreeViewStateWithColumns {
        ...
        public void OnGUI(Rect rect)
        {
            ...
            GUI.Label(position, "", EditorStyles.toolbar);
            ...
            {
                int num3 = this.GetNumItemsInData() / 10;
                this.m_TreeView.Frame(num3, true, false);
