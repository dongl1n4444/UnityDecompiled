namespace UnityEditor.TreeViewExamples
{
    ...
    internal class TreeViewTestWindow : EditorWindow, IHasCustomMenu
    {
        ...
        {
            menu.AddItem(new GUIContent("Large TreeView"), this.m_TestType == TestType.LargeTreesWithStandardGUI, () => this.m_TestType = TestType.LargeTreesWithStandardGUI);
            menu.AddItem(new GUIContent("Custom Item Height TreeView"), this.m_TestType == TestType.TreeWithCustomItemHeight, () => this.m_TestType = TestType.TreeWithCustomItemHeight);
        }
