...
internal class ClangCompiler : NativeCompiler
{
    ...
    {
        string arguments = $" -c -arch {this.m_Settings.MachineSpecification} -stdlib=libstdc++ -O0 -Wno-unused-value -Wno-invalid-offsetof -fvisibility=hidden -fno-rtti -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/include {includePaths} -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.8.sdk -mmacosx-version-min=10.6 -single_module -compatibility_version 1 -current_version 1 {file} -o {base.ObjectFileFor(file)}";
    ...
    {
        <CompileDynamicLibrary>c__AnonStorey7D storeyd = new <CompileDynamicLibrary>c__AnonStorey7D {
            <>f__this = this
        };
        ...
        storeyd.includeDirs = includePaths.Aggregate<string, string>(string.Empty, <>f__am$cache1);
        ...
        NativeCompiler.ParallelFor<string>(strArray, new Action<string>(storeyd.<>m__11C));
    ...
    [CompilerGenerated]
    private sealed class <CompileDynamicLibrary>c__AnonStorey7D
    {
        internal ClangCompiler <>f__this;
        internal string includeDirs;

        internal void <>m__11C(string file)
        {
