namespace UnityEditor.MemoryProfiler
{
    ...
    public struct TypeDescription
    {
        ...
        public bool isValueType =>
            ((this.m_Flags & TypeFlags.kValueType) != TypeFlags.kNone);
        /// <summary>
        /// <para>Is this type an array?</para>
        /// </summary>
        public bool isArray =>
            ((this.m_Flags & TypeFlags.kArray) != TypeFlags.kNone);
        /// <summary>
