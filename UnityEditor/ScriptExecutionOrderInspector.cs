namespace UnityEditor
{
    ...
    internal class ScriptExecutionOrderInspector : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            {
                <>f__mg$cache0 = new EditorGUI.ObjectFieldValidator(ScriptExecutionOrderInspector.MonoScriptValidatorCallback);
            }
            MonoScript script = EditorGUI.DoDropField(position, id, typeof(MonoScript), <>f__mg$cache0, false, m_Styles.dropField) as MonoScript;
            if (script != null)
            {
