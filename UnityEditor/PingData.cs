            ...
            if (this.isPinging)
            {
                ...
                if ((num2 > 0f) && (num2 < num))
                {
                    ...
                    if (num2 < this.m_ZoomTime)
                    {
                        ...
                        Vector2 vector3 = GUIClip.Unclip(pos);
                        Matrix4x4 matrixx3 = Matrix4x4.TRS((Vector3) vector3, Quaternion.identity, new Vector3(x, x, 1f)) * Matrix4x4.TRS((Vector3) -vector3, Quaternion.identity, Vector3.one);
