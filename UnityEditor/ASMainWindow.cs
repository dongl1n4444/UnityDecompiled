namespace UnityEditor
{
    ...
    internal class ASMainWindow : EditorWindow, IHasCustomMenu
    {
        ...
        private string[] commitDropDownMenuItems = new string[] { "Commit", "", "Compare", "Compare Binary", "", "Discard" };
        private string commitMessage;
        private bool committing;
        private string connectionString = "";
        public static Constants constants = null;
        private string[] dropDownMenuItems = new string[] { "Connection", "", "Show History", "Discard Changes", "", "Server Administration" };
        ...
        public ShowSearchField m_ShowSearch = ShowSearchField.None;
        private int maxNickLength = 1;
        private bool mySelection;
        private bool needsSetup = true;
        private string[] pageTitles = new string[] { "Overview", "Update", "Commit", "" };
        ...
        private string[] unconfiguredDropDownMenuItems = new string[] { "Connection", "", "Server Administration" };
        ...
        {
            this.SwitchSelectedPage((Page) page);
        }
        ...
        private void CommitContextMenuClick(object userData, string[] options, int selected)
        {
            if (selected >= 0)
            {
                switch (this.commitDropDownMenuItems[selected])
                {
                    case "Commit":
