namespace UnityEditor.Animations
{
    ...
    public class AnimatorTransitionBase : Object
    {
        ...
        /// </summary>
        public AnimatorCondition[] conditions { [MethodImpl(MethodImplOptions.InternalCall)] get; [MethodImpl(MethodImplOptions.InternalCall)] set; }

        /// <summary>
        /// <para>The destination state of the transition.</para>
        /// </summary>
        public AnimatorState destinationState { [MethodImpl(MethodImplOptions.InternalCall)] get; [MethodImpl(MethodImplOptions.InternalCall)] set; }

        /// <summary>
        /// <para>The destination state machine of the transition.</para>
        /// </summary>
        public AnimatorStateMachine destinationStateMachine { [MethodImpl(MethodImplOptions.InternalCall)] get; [MethodImpl(MethodImplOptions.InternalCall)] set; }

        /// <summary>
        /// <para>Is the transition destination the exit of the current state machine.</para>
        /// </summary>
        public bool isExit { [MethodImpl(MethodImplOptions.InternalCall)] get; [MethodImpl(MethodImplOptions.InternalCall)] set; }
