namespace UnityEditor
{
    ...
    internal class ProceduralMaterialInspector : MaterialEditor
    {
        ...
        private static int[] kTextureFormatValues = new int[] { 0, 2, 1, 3 };
        ...
        public static void ExportPreset(MenuCommand command)
        {
            ...
            if (exportPath != "")
            {
                ...
                SubstanceImporter atPath = AssetImporter.GetAtPath(AssetDatabase.GetAssetPath(context)) as SubstanceImporter;
                if (atPath != null)
                {
        ...
        {
            Texture[] generatedTextures = (base.target as ProceduralMaterial).GetGeneratedTextures();
