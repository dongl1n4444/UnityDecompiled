        ...
        private static IncludedFileList CrossCompileManagedDlls(BuildSettings bs, ProjectPaths paths, AssemblyReferenceChecker checker, RuntimeClassRegistry usedClassRegistry, BuildReport buildReport)
        {
            ...
            if (!bs.UseIl2Cpp())
            {
                ...
                if (stripping)
                {
                    ...
                    foreach (string str4 in Directory.GetFiles(fullPath))
                    {
            ...
            string str7 = storey.paths.stagingAreaDataManaged + "/Metadata";
            FileUtil.CreateOrCleanDirectory(str7);
            IL2CPPUtils.CopyMetadataFiles("Temp/il2cppOutput", str7);
