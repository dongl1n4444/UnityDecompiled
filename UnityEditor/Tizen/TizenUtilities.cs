namespace UnityEditor.Tizen
{
    ...
    internal class TizenUtilities
    {
        ...
        public static bool InstallTpkPackage(string installPath)
        {
            ...
            {
                string[] components = new string[] { FileUtil.UnityGetDirectoryName(installPath), "Device", FileUtil.UnityGetFileName(installPath) };
                args = " install \"" + Paths.Combine(components) + "\"";
            }
            else
            {
                string[] textArray2 = new string[] { " -s ", PlayerSettings.Tizen.deploymentTarget, " install \"", installPath, "\"" };
        ...
        public static bool ThisIsAUnityTestProject() => 
            (((((PlayerSettings.productName == "RuntimeTests") || (PlayerSettings.productName == "NativeTests")) || ((PlayerSettings.productName == "UnityGraphicsTests") || (PlayerSettings.productName == "PerformanceRuntimeTests"))) || (PlayerSettings.productName == "IntegrationTests")) || (PlayerSettings.productName == "ExternalAssembly"));
