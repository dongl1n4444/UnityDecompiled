...
internal class AssemblyValidation
{
    ...
    {
        <PriorityFor>c__AnonStorey78 storey = new <PriorityFor>c__AnonStorey78 {
            platform = platform
        };
        ...
        return ValidationRuleAttributesFor(type).Where<AssemblyValidationRule>(new Func<AssemblyValidationRule, bool>(storey.<>m__10A)).Select<AssemblyValidationRule, int>(<>f__am$cache3).FirstOrDefault<int>();
    }
    ...
    {
        <RegisterValidationRuleForPlatform>c__AnonStorey77 storey = new <RegisterValidationRuleForPlatform>c__AnonStorey77 {
            platform = platform
        };
        ...
        _rulesByPlatform[storey.platform].Sort(new Comparison<Type>(storey.<>m__109));
    }
    ...
    {
        <ValidationRulesFor>c__AnonStorey76 storey = new <ValidationRulesFor>c__AnonStorey76 {
            options = options
        };
        ...
        return ValidationRuleTypesFor(platform).Select<Type, IValidationRule>(new Func<Type, IValidationRule>(storey.<>m__106)).Where<IValidationRule>(<>f__am$cache1);
    }

    [DebuggerHidden]
    private static IEnumerable<Type> ValidationRuleTypesFor(RuntimePlatform platform) => 
        new <ValidationRuleTypesFor>c__Iterator5 { 
            platform = platform,
            <$>platform = platform,
            $PC = -2
        };
    ...
    [CompilerGenerated]
    private sealed class <PriorityFor>c__AnonStorey78
    {
        internal RuntimePlatform platform;

        internal bool <>m__10A(AssemblyValidationRule attr) => 
            (attr.Platform == this.platform);
    }

    [CompilerGenerated]
    private sealed class <RegisterValidationRuleForPlatform>c__AnonStorey77
    {
        internal RuntimePlatform platform;

        internal int <>m__109(Type a, Type b) => 
            AssemblyValidation.CompareValidationRulesByPriority(a, b, this.platform);
    }

    [CompilerGenerated]
    private sealed class <ValidationRulesFor>c__AnonStorey76
    {
        internal object[] options;

        internal IValidationRule <>m__106(Type t) => 
    ...
    private sealed class <ValidationRuleTypesFor>c__Iterator5 : IDisposable, IEnumerator, IEnumerable, IEnumerable<Type>, IEnumerator<Type>
    {
        ...
        internal int $PC;
        internal RuntimePlatform <$>platform;
        internal List<Type>.Enumerator <$s_908>__0;
        ...
        public bool MoveNext()
        {
            ...
            switch (num)
            {
                case 0:
                    ...
                    {
                        this.<$s_908>__0 = AssemblyValidation._rulesByPlatform[this.platform].GetEnumerator();
                        num = 0xfffffffd;
                        break;
                    }
                    goto Label_00C8;
            ...
            try
            {
                while (this.<$s_908>__0.MoveNext())
                {
                    this.<validationType>__1 = this.<$s_908>__0.Current;
