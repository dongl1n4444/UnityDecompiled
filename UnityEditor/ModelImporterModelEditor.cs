namespace UnityEditor
{
    ...
    internal class ModelImporterModelEditor : AssetImporterInspector
    {
        ...
        private void MeshesGUI()
        {
            ...
            {
                EditorGUI.indentLevel++;
                this.m_SecondaryUVAdvancedOptions = EditorGUILayout.Foldout(this.m_SecondaryUVAdvancedOptions, styles.GenerateSecondaryUVAdvanced, true, EditorStyles.foldout);
        ...
        private class Styles
        {
            ...
            public Styles()
            {
                ...
                this.TangentSpaceModeOptEnumsAll = new ModelImporterTangents[] { ModelImporterTangents.Import };
                this.TangentSpaceModeOptEnumsCalculate = new ModelImporterTangents[] { ModelImporterTangents.CalculateMikk };
