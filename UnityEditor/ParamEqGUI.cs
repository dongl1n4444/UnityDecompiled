namespace UnityEditor
{
    ...
    internal class ParamEqGUI : IAudioEffectPluginGUI
    {
        ...
        private static bool ParamEqualizerCurveEditor(IAudioEffectPlugin plugin, Rect r, ref float centerFreq, ref float bandwidth, ref float gain, float blend)
        {
            ...
            float num9;
            float num10;
            <ParamEqualizerCurveEditor>c__AnonStorey0 storey = new <ParamEqualizerCurveEditor>c__AnonStorey0 {
                plugin = plugin
            };
            ...
            {
                <ParamEqualizerCurveEditor>c__AnonStorey1 storey2 = new <ParamEqualizerCurveEditor>c__AnonStorey1 {
                    <>f__ref$0 = storey
                };
                ...
                AudioCurveRendering.DrawCurve(r, new AudioCurveRendering.AudioCurveEvaluator(storey2.<>m__0), ScaleAlpha(AudioCurveRendering.kAudioOrange, blend));
            }
        ...
        [CompilerGenerated]
        private sealed class <ParamEqualizerCurveEditor>c__AnonStorey1
        {
            internal ParamEqGUI.<ParamEqualizerCurveEditor>c__AnonStorey0 <>f__ref$0;
            internal double a0;
            internal double a1;
            internal double a2;
            internal double b0;
            ...
            internal float <>m__0(float x)
            {
                double num = ParamEqGUI.MapNormalizedFrequency((double) x, (double) this.<>f__ref$0.plugin.GetSampleRate(), true, true);
