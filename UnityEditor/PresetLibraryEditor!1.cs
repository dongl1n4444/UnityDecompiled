namespace UnityEditor
{
    ...
    internal class PresetLibraryEditor<T> where T: PresetLibrary
    {
        ...
        public PresetLibraryEditor(ScriptableObjectSaveLoadHelper<T> helper, PresetLibraryEditorState state, Action<int, object> itemClickedCallback)
        {
            ...
            this.m_ShowedScrollBarLastFrame = false;
        ...
        private class SettingsMenu
        {
            ...
            public static void Show(Rect activatorRect, PresetLibraryEditor<T> owner)
            {
                ...
                for (int i = 0; i < list.Count; i++)
                {
                    ...
                    menu.AddItem(list[i].text, on, PresetLibraryEditor<T>.SettingsMenu.<>f__mg$cache0, list[i]);
                }
                menu.AddSeparator("");
                ScriptableSingleton<PresetLibraryManager>.instance.GetAvailableLibraries<T>(PresetLibraryEditor<T>.SettingsMenu.s_Owner.m_SaveLoadHelper, out list3, out list4);
                list3.Sort();
                list4.Sort();
                ...
                foreach (string str3 in list3)
                {
                    ...
                    menu.AddItem(new GUIContent(fileNameWithoutExtension), str == str3, PresetLibraryEditor<T>.SettingsMenu.<>f__mg$cache1, str3);
                }
                foreach (string str5 in list4)
                {
                    ...
                    menu.AddItem(new GUIContent(str6 + str2), str == str5, PresetLibraryEditor<T>.SettingsMenu.<>f__mg$cache2, str5);
                }
                menu.AddSeparator("");
                ...
                menu.AddItem(new GUIContent("Create New Library..."), false, PresetLibraryEditor<T>.SettingsMenu.<>f__mg$cache3, 0);
                if (PresetLibraryEditor<T>.SettingsMenu.HasDefaultPresets())
                {
                    ...
                    menu.AddItem(new GUIContent("Add Factory Presets To Current Library"), false, PresetLibraryEditor<T>.SettingsMenu.<>f__mg$cache4, 0);
                }
                menu.AddSeparator("");
                ...
                menu.AddItem(new GUIContent("Reveal Current Library Location"), false, PresetLibraryEditor<T>.SettingsMenu.<>f__mg$cache5, 0);
        ...
        private class Styles
        {
            ...
            public Styles()
            {
                ...
                this.plusButtonText = new GUIContent("", "Add new preset");
                this.plusButtonTextNotCheckedOut = new GUIContent("", "To add presets you need to press the 'Check out' button below");
