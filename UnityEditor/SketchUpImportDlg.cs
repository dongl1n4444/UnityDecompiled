namespace UnityEditor
{
    ...
    internal class SketchUpImportDlg : EditorWindow
    {
        ...
        private void HandleKeyboardEvents()
        {
            ...
            {
                SketchUpNode node = this.m_TreeView.FindItem(this.m_Selection[0]) as SketchUpNode;
        ...
        private void OnGUI()
        {
            ...
            Rect rect4 = new Rect(0f, 0f, base.position.width, 25f);
            GUI.Label(rect4, string.Empty, Styles.styles.headerStyle);
            ...
            GUILayout.Box("", Styles.styles.boxBackground, options);
            GUILayout.Space(2f);
            ...
            GUILayout.EndArea();
            position.y = 18f;
            position.height -= (rect4.height + screenRect.height) - 7f;
        ...
        internal class Styles
        {
            ...
            public static SketchUpImportDlg.Styles styles
            {
                get
                {
                    SketchUpImportDlg.Styles styles;
                    if (s_Styles != null)
                    {
                        styles = s_Styles;
                    }
                    ...
                    {
                        styles = s_Styles = new SketchUpImportDlg.Styles();
                    }
                    return styles;
                }
            }
