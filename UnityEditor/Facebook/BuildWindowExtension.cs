    ...
    internal class BuildWindowExtension : DefaultBuildWindowExtension
    {
        ...
        public override void ShowPlatformBuildOptions()
        {
            ...
            if (index == selectedIndex)
            {
                ...
                {
                    GUILayout.Space(20f);
                    GUILayout.Label("No " + BuildPlatforms.instance.GetBuildTargetDisplayName(selectedFacebookTarget) + " module loaded.", new GUILayoutOption[0]);
            ...
            if (GUILayout.Button("Upload last build to Facebook", EditorStyles.miniButton, optionArray2))
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        string str6 = (EditorUserBuildSettings.selectedFacebookTarget != BuildTarget.WebGL) ? "GAMES_DESKTOP" : "PLATFORM_WEBGL";
