...
namespace UnityEditor.Graphs.AnimationStateMachine
{
	...
	internal class EntryNodeInspector : Editor
	{
		...
		private void Init()
		{
			...
			{
				this.m_TransitionsEditor = new SourceNodeTransitionEditor((base.target as EntryNode).undoableObject as AnimatorStateMachine, TransitionType.eEntry, this);
			}
		}
		...
		public override void OnInspectorGUI()
		{
			this.Init();
			GUI.enabled = true;
			EntryNode entryNode = base.target as EntryNode;
