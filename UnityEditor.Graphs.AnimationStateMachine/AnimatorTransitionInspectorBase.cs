...
namespace UnityEditor.Graphs.AnimationStateMachine
{
	internal abstract class AnimatorTransitionInspectorBase : Editor
	{
		...
		public virtual void OnEnable()
		{
			...
			ReorderableList arg_88_0 = this.m_TransitionList;
			if (AnimatorTransitionInspectorBase.<>f__mg$cache0 == null)
			{
				AnimatorTransitionInspectorBase.<>f__mg$cache0 = new ReorderableList.HeaderCallbackDelegate(AnimatorTransitionInspectorBase.DrawTransitionHeaderCommon);
			}
			arg_88_0.drawHeaderCallback = AnimatorTransitionInspectorBase.<>f__mg$cache0;
			...
			if (this.m_Controller)
			{
				...
				UnityEditor.Animations.AnimatorController expr_10A = this.m_Controller;
				expr_10A.OnAnimatorControllerDirty = (Action)Delegate.Combine(expr_10A.OnAnimatorControllerDirty, new Action(this.ControllerDirty));
			}
		...
		public virtual void OnDisable()
		{
			if (this.m_Controller)
			{
				UnityEditor.Animations.AnimatorController expr_17 = this.m_Controller;
		...
		internal override void DrawHeaderHelpAndSettingsGUI(Rect r)
		{
			...
			{
				if (Help.HasHelpForObject(this.m_SerializedTransition.targetObject))
				{
					if (GUI.Button(new Rect(r.width - 36f, r.y + 5f, 14f, 14f), EditorGUI.GUIContents.helpIcon, EditorStyles.inspectorTitlebarText))
					{
