namespace UnityScript
{
    ...
    public class UnityScriptCompiler
    {
        ...
        {
            return this._compiler.Run(compileUnit);
        }
        ...
        public static class Pipelines
        {
            ...
            {
                return AdjustBooPipeline(new Boo.Lang.Compiler.Pipelines.Compile());
            }

            public static CompilerPipeline CompileToBoo()
            {
                return AdjustBooPipeline(new Boo.Lang.Compiler.Pipelines.CompileToBoo());
            }

            public static CompilerPipeline CompileToFile()
            {
                return AdjustBooPipeline(new Boo.Lang.Compiler.Pipelines.CompileToFile());
            }

            public static CompilerPipeline CompileToMemory()
            {
                return AdjustBooPipeline(new Boo.Lang.Compiler.Pipelines.CompileToMemory());
            }
