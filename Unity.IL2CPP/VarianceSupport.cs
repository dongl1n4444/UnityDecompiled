...
namespace Unity.IL2CPP
{
	public sealed class VarianceSupport
	{
		...
		{
			return !leftType.IsFunctionPointer && !rightType.IsFunctionPointer && ((leftType.FullName != rightType.FullName && (leftType.IsByReference & rightType.IsPointer)) || (!leftType.IsByReference && !rightType.IsByReference && !(leftType.FullName == rightType.FullName) && (leftType.IsArray || rightType.IsArray)));
		}
