	...
	internal class ComCallableWrapperMethodBodyWriter : NativeToManagedInteropMethodBodyWriter
	{
		...
		protected override void WriteInteropCallStatement(CppCodeWriter writer, string[] localVariableNames, IRuntimeMetadataAccess metadataAccess)
		{
			...
			using (new BlockWriter(writer, false))
			{
				...
				{
					writer.WriteLine("{0}* {1} = ({0}*)UnBox(il2cpp_gchandle_get_target(__handle), {2});", new object[]
					{
				...
				{
					writer.WriteLine("{0} {1} = ({0})il2cpp_gchandle_get_target(__handle);", new object[]
					{
		...
		protected override void WriteReturnStatement(CppCodeWriter writer, string unmarshaledReturnValueVariableName, IRuntimeMetadataAccess metadataAccess)
		{
