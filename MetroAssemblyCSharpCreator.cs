...
internal static class MetroAssemblyCSharpCreator
{
    ...
    internal static string GetAssemblyCSharpConfigs(WSASDK wsaSDK, IEnumerable<string> defines)
    {
        ...
        if (defines == null)
        {
            str2 = "NETFX_CORE;ENABLE_WINMD_SUPPORT;UNITY_METRO;PLATFORM_METRO;ENABLE_WWW;ENABLE_UNITYWEBREQUEST;UNITY_WINRT;PLATFORM_WINRT;ENABLE_AUDIO_FMOD;ENABLE_PHYSICS;ENABLE_TERRAIN;ENABLE_CACHING;ENABLE_GENERICS;ENABLE_MOVIES;ENABLE_AUDIO";
