namespace TreeEditor
{
    ...
    public class RingLoop
    {
        ...
        private float flareNoise = 0f;
        private float flareRadius = 0f;
        ...
        private float spreadBot = 0f;
        private float spreadTop = 0f;
        private float surfAngleCos = 0f;
        private float surfAngleSin = 0f;
