	...
	public class Node : UnityEditor.Graphs.Node
	{
		...
		public int childIndex
		{
			get
			{
				...
				{
					result = this.m_Parent.children.IndexOf(this);
				}
				return result;
			}
		}
		...
		private void CreateStateMachine()
		{
			if (this.m_Animator != null)
			{
				if (this.m_Controller == null)
				{
					...
					AnimatorController expr_100 = this.m_Controller;
					expr_100.OnAnimatorControllerDirty = (Action)Delegate.Combine(expr_100.OnAnimatorControllerDirty, new Action(this.ControllerDirty));
		...
		private void OnDestroy()
		{
			if (this.m_Controller != null)
			{
				AnimatorController expr_18 = this.m_Controller;
				expr_18.OnAnimatorControllerDirty = (Action)Delegate.Remove(expr_18.OnAnimatorControllerDirty, new Action(this.ControllerDirty));
			}
