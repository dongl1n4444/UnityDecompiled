namespace UnityEditorInternal
{
    ...
    {
        public GUIStyle listElementStyle = null;
        ...
        public GUIStyle renameOverlayStyle = null;
        ...
        private void CommandHandling()
        {
            ...
            if (Event.current.type == EventType.ExecuteCommand)
            {
                ...
                if ((commandName != null) && (commandName == "OnLostFocus"))
                {
                    this.EndRename(true);
                    current.Use();
                }
        ...
        public GUIStyle elementStyle
        {
            get
            {
                GUIStyle listElementStyle;
                if (this.listElementStyle != null)
                {
                    listElementStyle = this.listElementStyle;
                }
                else
                {
                    listElementStyle = s_Styles.reorderableListLabel;
                }
                return listElementStyle;
            }
        }
