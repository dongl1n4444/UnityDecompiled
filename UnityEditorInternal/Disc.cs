            ...
            switch (current.GetTypeForControl(id))
            {
                ...
                case EventType.Repaint:
                {
                    ...
                    if (GUIUtility.hotControl == id)
                    {
                        ...
                        Vector3 vector10 = s_StartPosition - position;
                        Vector3 from = vector10.normalized;
                        ...
                        Vector3 vector11 = (Vector3) (Quaternion.AngleAxis(angle, axis) * from);
                        Handles.DrawLine(position, position + ((Vector3) ((vector11 * size) * 1.1f)));
                    ...
                    if (cutoffPlane)
                    {
                        Vector3 vector12 = Vector3.Cross(axis, Camera.current.transform.forward).normalized;
                        Handles.DrawWireArc(position, axis, vector12, 180f, size);
                    }
                    else
                    {
