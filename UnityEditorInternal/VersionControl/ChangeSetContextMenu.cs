namespace UnityEditorInternal.VersionControl
{
    ...
    public class ChangeSetContextMenu
    {
        ...
        private static bool DeleteChangeSetTest(int userData)
        {
            ...
            bool flag2 = (((changeSetItem != null) && changeSetItem.HasChildren) && (changeSetItem.FirstChild.Asset != null)) && (changeSetItem.FirstChild.Name != "Empty change list");
            if (!flag2)
            {
                Task task = Provider.ChangeSetStatus(changeSet);
                task.Wait();
                flag2 = task.assetList.Count != 0;
            }
            return (!flag2 && Provider.DeleteChangeSetsIsValid(selectedChangeSets));
        }
