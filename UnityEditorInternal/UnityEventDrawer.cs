namespace UnityEditorInternal
{
    ...
    public class UnityEventDrawer : PropertyDrawer
    {
        ...
        [CompilerGenerated]
        private static Func<PropertyInfo, bool> <>f__am$cache2;
        [CompilerGenerated]
        ...
        [CompilerGenerated]
        private static Func<Component, string> <>f__am$cache6;
        [CompilerGenerated]
        private static Func<string, string> <>f__am$cache7;
        [CompilerGenerated]
        private static Func<IGrouping<string, string>, bool> <>f__am$cache8;
        [CompilerGenerated]
        ...
        [CompilerGenerated]
        private static Func<ValidMethodMap, string> <>f__am$cacheC;
        [CompilerGenerated]
        ...
        private static void AddFunctionsForScript(GenericMenu menu, SerializedProperty listener, ValidMethodMap method, string targetName)
        {
            ...
            {
                <>f__mg$cache1 = new GenericMenu.MenuFunction2(UnityEventDrawer.SetEventFunction);
            }
            menu.AddItem(new GUIContent(text), on, <>f__mg$cache1, new UnityEventFunction(listener, method.target, method.methodInfo, mode));
        }
        ...
        private static void AddMethodsToMenu(GenericMenu menu, SerializedProperty listener, List<ValidMethodMap> methods, string targetName)
        {
            ...
            {
                AddFunctionsForScript(menu, listener, map, targetName);
            }
        }
        ...
        private static GenericMenu BuildPopupList(UnityEngine.Object target, UnityEventBase dummyEvent, SerializedProperty listener)
        {
            ...
            {
                <>f__mg$cache0 = new GenericMenu.MenuFunction2(UnityEventDrawer.ClearEventFunction);
            }
            menu.AddItem(new GUIContent("No Function"), string.IsNullOrEmpty(property.stringValue), <>f__mg$cache0, new UnityEventFunction(listener, null, null, PersistentListenerMode.EventDefined));
            if (gameObject != null)
            {
                menu.AddSeparator("");
        ...
        private void DrawEventListener(Rect rect, int index, bool isactive, bool isfocused)
        {
            ...
            using (new EditorGUI.DisabledScope(property5.objectReferenceValue == null))
            {
