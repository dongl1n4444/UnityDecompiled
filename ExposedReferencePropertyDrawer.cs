...
{
    protected override void OnRenderProperty(Rect position, PropertyName exposedPropertyNameString, Object currentReferenceValue, SerializedProperty exposedPropertyDefault, SerializedProperty exposedPropertyName, BaseExposedPropertyDrawer.ExposedPropertyMode mode, IExposedPropertyTable exposedPropertyTable)
    {
        Type objType = base.fieldInfo.FieldType.GetGenericArguments()[0];
        EditorGUI.BeginChangeCheck();
        Object target = EditorGUI.ObjectField(position, currentReferenceValue, objType, exposedPropertyTable != null);
    ...
    private sealed class <PopulateContextMenu>c__AnonStorey0
    {
        ...
        internal void <>m__0(object userData)
        {
            ...
            Undo.RecordObject(this.exposedPropertyTable as Object, "Set Exposed Property");
        ...
        internal void <>m__1(object userData)
        {
            ...
            this.exposedName.serializedObject.ApplyModifiedProperties();
            Undo.RecordObject(this.exposedPropertyTable as Object, "Clear Exposed Property");
