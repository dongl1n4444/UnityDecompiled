namespace UnityEngine
{
    ...
    public sealed class HingeJoint : Joint
    {
        ...
        /// </summary>
        public float angle { [MethodImpl(MethodImplOptions.InternalCall)] get; }
        ...
        /// </summary>
        public bool useSpring { [MethodImpl(MethodImplOptions.InternalCall)] get; [MethodImpl(MethodImplOptions.InternalCall)] set; }

        /// <summary>
        /// <para>The angular velocity of the joint in degrees per second. (Read Only)</para>
        /// </summary>
        public float velocity { [MethodImpl(MethodImplOptions.InternalCall)] get; }
    }
}
