namespace UnityEngine
{
    ...
    public sealed class AudioSettings
    {
        ...
        public static double dspTime { [MethodImpl(MethodImplOptions.InternalCall)] get; }

        internal static bool editingInPlaymode { [MethodImpl(MethodImplOptions.InternalCall)] get; [MethodImpl(MethodImplOptions.InternalCall)] set; }

        /// <summary>
        /// <para>Get the mixer's current output rate.</para>
        /// </summary>
        public static int outputSampleRate { [MethodImpl(MethodImplOptions.InternalCall)] get; [MethodImpl(MethodImplOptions.InternalCall)] set; }

        internal static int profilerCaptureFlags { [MethodImpl(MethodImplOptions.InternalCall)] get; }

        /// <summary>
        /// <para>Gets the current speaker mode. Default is 2 channel stereo.</para>
        /// </summary>
        public static AudioSpeakerMode speakerMode { [MethodImpl(MethodImplOptions.InternalCall)] get; [MethodImpl(MethodImplOptions.InternalCall)] set; }

        internal static bool unityAudioDisabled { [MethodImpl(MethodImplOptions.InternalCall)] get; }
