namespace UnityEngine
{
    ...
    public enum LightmapsMode
    {
        ...
        Directional = 2,
        [Obsolete("Enum member LightmapsMode.Dual has been removed. Use CombinedDirectional instead (UnityUpgradable) -> CombinedDirectional", true), EditorBrowsable(EditorBrowsableState.Never)]
        Dual = 1,
        /// <summary>
        ...
        /// </summary>
        [Obsolete("Enum member LightmapsMode.SeparateDirectional has been removed. Use CombinedDirectional instead (UnityUpgradable) -> CombinedDirectional", true), EditorBrowsable(EditorBrowsableState.Never)]
