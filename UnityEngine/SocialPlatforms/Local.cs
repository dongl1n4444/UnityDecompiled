namespace UnityEngine.SocialPlatforms
{
    ...
    public class Local : ISocialPlatform
    {
        ...
        private void PopulateStaticData()
        {
            ...
            item.SetScores(new List<Score> { 
                new Score("Leaderboard01", 300L, "1001", DateTime.Now.AddDays(-1.0), "300 points", 1),
                new Score("Leaderboard01", 0xffL, "1002", DateTime.Now.AddDays(-1.0), "255 points", 2),
                new Score("Leaderboard01", 0x37L, "1003", DateTime.Now.AddDays(-1.0), "55 points", 3),
        ...
        private void SortScores(Leaderboard board)
        {
            ...
            {
                <>f__am$cache0 = (s1, s2) => s2.value.CompareTo(s1.value);
            }
        ...
        {
            <UnityEngine_SocialPlatforms_ISocialPlatform_Authenticate>c__AnonStorey0 storey = new <UnityEngine_SocialPlatforms_ISocialPlatform_Authenticate>c__AnonStorey0 {
                callback = callback
            };
            ((ISocialPlatform) this).Authenticate(user, new Action<bool>(storey.<>m__0));
        }
