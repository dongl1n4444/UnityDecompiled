namespace UnityEngine
{
    ...
    public sealed class GL
    {
        ...
        [MethodImpl(MethodImplOptions.InternalCall), Obsolete("IssuePluginEvent(eventID) is deprecated. Use IssuePluginEvent(callback, eventID) instead.")]
        ...
        [MethodImpl(MethodImplOptions.InternalCall), Obsolete("Use invertCulling property")]
        ...
        /// </summary>
        public static bool invertCulling { [MethodImpl(MethodImplOptions.InternalCall)] get; [MethodImpl(MethodImplOptions.InternalCall)] set; }
        ...
        /// </summary>
        public static bool sRGBWrite { [MethodImpl(MethodImplOptions.InternalCall)] get; [MethodImpl(MethodImplOptions.InternalCall)] set; }

        /// <summary>
        /// <para>Should rendering be done in wireframe?</para>
        /// </summary>
        public static bool wireframe { [MethodImpl(MethodImplOptions.InternalCall)] get; [MethodImpl(MethodImplOptions.InternalCall)] set; }
    }
}
