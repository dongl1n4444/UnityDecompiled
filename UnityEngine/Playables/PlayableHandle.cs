namespace UnityEngine.Playables
{
    ...
    public struct PlayableHandle
    {
        ...
        public T GetObject<T>() where T: IPlayable
        {
            ...
            object scriptInstance = GetScriptInstance(ref this);
            if (scriptInstance != null)
            {
                return (T) scriptInstance;
            }
            T local3 = (T) Activator.CreateInstance(GetPlayableTypeOf(ref this));
            local3.playableHandle = this;
            SetScriptInstance(ref this, local3);
            return local3;
        }
        ...
        /// <summary>
        /// <para>Tells the playable that calls to set its local time should be propagated to its inputs.</para>
        /// </summary>
        public bool propagateSetTime
        {
            get => 
                InternalGetPropagateSetTime(ref this);
            set
            {
                InternalSetPropagateSetTime(ref this, value);
            }
        }
        ...
        private static bool InternalGetPropagateSetTime(ref PlayableHandle playable) => 
            INTERNAL_CALL_InternalGetPropagateSetTime(ref playable);
        ...
        /// <returns>
        /// <para>Returns true if the call succeeded, false otherwise.</para>
        /// </returns>
