namespace UnityEngine
{
    ...
    public sealed class Sprite : UnityEngine.Object
    {
        ...
        /// </summary>
        public Texture2D associatedAlphaSplitTexture { [MethodImpl(MethodImplOptions.InternalCall), GeneratedByOldBindingsGenerator] get; }
        ...
        /// </summary>
        public bool packed { [MethodImpl(MethodImplOptions.InternalCall), GeneratedByOldBindingsGenerator] get; }

        /// <summary>
        /// <para>If Sprite is packed (see Sprite.packed), returns its SpritePackingMode.</para>
        /// </summary>
        public SpritePackingMode packingMode { [MethodImpl(MethodImplOptions.InternalCall), GeneratedByOldBindingsGenerator] get; }

        /// <summary>
        /// <para>If Sprite is packed (see Sprite.packed), returns its SpritePackingRotation.</para>
        /// </summary>
        public SpritePackingRotation packingRotation { [MethodImpl(MethodImplOptions.InternalCall), GeneratedByOldBindingsGenerator] get; }
        ...
        /// </summary>
        public float pixelsPerUnit { [MethodImpl(MethodImplOptions.InternalCall), GeneratedByOldBindingsGenerator] get; }
        ...
        /// </summary>
        public Texture2D texture { [MethodImpl(MethodImplOptions.InternalCall), GeneratedByOldBindingsGenerator] get; }
        ...
        /// </summary>
        public ushort[] triangles { [MethodImpl(MethodImplOptions.InternalCall), GeneratedByOldBindingsGenerator] get; }

        /// <summary>
        /// <para>The base texture coordinates of the sprite mesh.</para>
        /// </summary>
        public Vector2[] uv { [MethodImpl(MethodImplOptions.InternalCall), GeneratedByOldBindingsGenerator] get; }

        /// <summary>
        /// <para>Returns a copy of the array containing sprite mesh vertex positions.</para>
        /// </summary>
        public Vector2[] vertices { [MethodImpl(MethodImplOptions.InternalCall), GeneratedByOldBindingsGenerator] get; }
    }
}
