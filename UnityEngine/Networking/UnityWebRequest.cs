namespace UnityEngine.Networking
{
    ...
    public sealed class UnityWebRequest : IDisposable
    {
        ...
        {
            System.Type type = System.Type.GetType("UnityEngine.Networking.DownloadHandlerAudioClip");
            if (type == null)
            {
                return Get(uri);
            }
            System.Type[] types = new System.Type[] { typeof(string), typeof(AudioType) };
            ConstructorInfo constructor = type.GetConstructor(types);
            object[] parameters = new object[] { uri, audioType };
            return new UnityWebRequest(uri, "GET", constructor.Invoke(parameters) as DownloadHandler, null);
        }
