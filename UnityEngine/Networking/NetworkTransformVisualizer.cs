namespace UnityEngine.Networking
{
    ...
    /// </summary>
    [DisallowMultipleComponent, AddComponentMenu("Network/NetworkTransformVisualizer"), RequireComponent(typeof(NetworkTransform)), EditorBrowsable(EditorBrowsableState.Never)]
