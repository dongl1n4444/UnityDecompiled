namespace UnityEngine.Networking.PlayerConnection
{
    ...
    public class PlayerConnection : ScriptableObject, IEditorPlayerConnection
    {
        ...
        {
            s_Instance = ScriptableObject.CreateInstance<UnityEngine.Networking.PlayerConnection.PlayerConnection>();
        ...
        private IPlayerEditorConnectionNative GetConnectionNativeApi()
        {
            ...
            if (UnityEngine.Networking.PlayerConnection.PlayerConnection.connectionNative != null)
            {
                connectionNative = UnityEngine.Networking.PlayerConnection.PlayerConnection.connectionNative;
            }
            else
            {
        ...
        public bool isConnected =>
            this.GetConnectionNativeApi().IsConnected();
