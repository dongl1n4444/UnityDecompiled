namespace UnityEngine
{
    ...
    public sealed class ShaderVariantCollection : UnityEngine.Object
    {
        ...
        /// </summary>
        public bool isWarmedUp { [MethodImpl(MethodImplOptions.InternalCall)] get; }

        /// <summary>
        /// <para>Number of shaders in this collection (Read Only).</para>
        /// </summary>
        public int shaderCount { [MethodImpl(MethodImplOptions.InternalCall)] get; }

        /// <summary>
        /// <para>Number of total varians in this collection (Read Only).</para>
        /// </summary>
        public int variantCount { [MethodImpl(MethodImplOptions.InternalCall)] get; }
