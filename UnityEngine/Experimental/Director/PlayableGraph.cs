namespace UnityEngine.Experimental.Director
{
    ...
    public struct PlayableGraph
    {
        ...
        {
            PlayableHandle @null = PlayableHandle.Null;
            ScriptPlayable playable = InternalCreateScriptPlayable(ref this, ref @null, typeof(T)) as ScriptPlayable;
            if (playable == null)
            {
                return PlayableHandle.Null;
            }
            playable.handle = @null;
            return @null;
        }
        ...
        private static object InternalCreateScriptPlayable(ref PlayableGraph graph, ref PlayableHandle handle, Type type) => 
            INTERNAL_CALL_InternalCreateScriptPlayable(ref graph, ref handle, type);
